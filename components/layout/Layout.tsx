          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="col-span-1 md:col-span-2">
                <h3 className="text-xl font-bold mb-4">🚀 AI Chatbot Solutions</h3>
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-400">
                  <li><a href="mailto:burger@theburgerllc.com" className="hover:text-white transition-colors">Email Support</a></li>
                  <li><a href="tel:+13329994484" className="hover:text-white transition-colors">Phone Support</a></li>
                </ul>
              </div>
            </div>
